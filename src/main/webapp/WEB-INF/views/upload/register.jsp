...
let conChild = "";
conChild = `<div class='content-group' id='data-content-`+cnt+`'>
      <h3 name='stepNo' id='stepNo' value='`+cnt+`'>`+cnt+`</h3>
      <div class="uploadImgDiv`+cnt+`">
		<input type="file" name='uploadFile`+cnt+`'>
		</div>	  
	...
	$(document).ready(function(e){
		...
		$("button[type='submit']").on("click", function(e){
			...
			$(".uploadResult ul li").each(function(i, obj){
				...
				console.log(jobj);
				var photoUrl = jobj.data("path")+"\\"+jobj.data("uuid")+"\\"+jobj.data("filename");
				var thumbUrl = "C:\\upload\\"+jobj.data("path")+"\\s_"+jobj.data("uuid")+"_"+jobj.data("filename");
		...
		$('body').on('click', "input[type='file']", function(e){		
			...
			var inputFile = $("input[name='uploadFile"+cnt+"']");
